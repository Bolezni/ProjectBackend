...
public class UserController {
    ...
    public ResponseEntity<?> addInterestToUser(@PathVariable(name = "login") String userName,
                                               @RequestParam(name = "interest_name") String interestName) {
        userService.addInterestToUser(userName, interestName);
